  ...
  return (
    <div className="content">
      ...
      {value.token &&user.user.userId ? (
        <DataContext.Provider value={{ sports:value.sports, token: value.token }}>
       ...
       <Login localUserId={user.user.userId} loaclToken={value.token} onChangeToken={onChangeToken} onChangeUser={onChangeUser}/>
      )}
    </div>
  );
};
